...
const BasicSpecs = ({ car }) => {
  console.log(car);
  return (
    <div className="flex flex-col w-[90vw] h-[20vh] mt-6 lg:w-[60vw] lg:h-[18vh] pl-4 bg-veryLightGray">
      {/* Row 1 */}
      <div className="flex  md:w-[100%] justify-between pt-4">
        ...
        <div className="flex w-[25%]">
          ...
          <h3 className="pl-2">{car.frontRimDesc ? car.frontRimDesc : "NA"}</h3>
        </div>
        {/* Item 4 */}
        <div className="flex w-[25%]">
      ...
      <div className="flex  md:w-[100%] justify-between mt-10">
        ...
        <div className="flex w-[25%]">
          ...
          <h3 className="pl-2">{car.seriesPublic ? car.seriesPublic : "NA"}</h3>
        </div>
        {/* Item 8 */}
        <div className="flex w-[25%]">
